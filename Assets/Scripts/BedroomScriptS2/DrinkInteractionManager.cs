...
public class DrinkInteractionManager : MonoBehaviour
{
    ...
    public AudioSource drinkAudioSource; // Reference to the AudioSource for drinking sound
    ...
    private void Start()
    {
        ...
        {
            Debug.LogError("Drink AudioSource is not assigned in the Inspector!");
        }
    }
    ...
    private System.Collections.IEnumerator PlayDrinkAudioAfterDelay(float delay)
    {
        // Wait for the specified delay
        yield return new WaitForSeconds(delay);

        // Play the drink audio
        if (drinkAudioSource != null)
        {
            drinkAudioSource.Play();
            Debug.Log("Drink audio started!");
