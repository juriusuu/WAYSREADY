...
public class RadioInteractionManagerS2 : MonoBehaviour
{
    ...
    public PostRadio postRadio; // Reference to the PostRadioInteractionManager
    ...
    private void OnInteractButtonPressed()
    {
        ...
        FindObjectOfType<QuestClipboardManager>()?.CompleteTask(1); // Assuming this is the task index
