...
public class PostEmergencyKitInteractionManager : MonoBehaviour
{
    ...
    public void ActivatePostInteraction()
    {
        if (isActivated)
        {
            Debug.LogWarning("Post-emergency kit interaction has already been activated.");
            return;
        }

        isActivated = true; // Mark as activated
        Debug.Log("Post-emergency kit interaction activated!");
