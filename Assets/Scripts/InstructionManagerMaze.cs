...
public class InstructionManagerMaze : MonoBehaviour
{
    ...
    public TaymerManagerFireEscape taymerManager; // Also control the timer

    void Awake() // Use Awake to run before other Start() methods
    {
        // Find managers
        stageDialogueManager = FindObjectOfType<StageDialogueManager1>();
        taymerManager = FindObjectOfType<TaymerManagerFireEscape>();
