...
public class GameStateManager : MonoBehaviour
{
    ...
    public bool IsNewGame { get; private set; } = true; // Default to new game
    ...
    {
        IsNewGame = true;
        sceneState.Clear(); // Clear any saved state
        if (File.Exists(saveFilePath))
        {
            File.Delete(saveFilePath); // Delete the saved file for a fresh start
            Debug.Log("New game started. Previous save file deleted.");
        }
        else
        {
            Debug.Log("New game started. No previous save file found.");
        }
    }
    ...
    {
        IsNewGame = false;
        LoadSceneState(); // Load the saved scene state from the file
    ...
    public void LoadSceneState()
    {
        ...
        {
            Debug.LogWarning("No saved scene state found. Starting with default state.");
        }
    }
